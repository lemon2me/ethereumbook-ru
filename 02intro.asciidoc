...
((("Ropsten Test Network")))Переключите метамаску на _тестовую сеть Ropsten_. Нажмите кнопку "Внести депозит", затем нажмите кнопку "Ropsten Test Faucet". MetaMask откроет новую веб-страницу, как показано на <<metamask_ropsten_faucet>>.
...
Давайте возьмем еще немного тестового эфира! Снова нажмите зеленую кнопку "запросить 1 эфир с крана" и подождите несколько секунд. Не волнуйтесь, в сети должно быть много эфира, и она даст вам больше, если вы попросите.

Как только у вас будет баланс в 2 ETH, вы можете попробовать еще раз. На этот раз, когда вы нажимаете оранжевую кнопку пожертвования "1 эфира", у вас есть достаточный баланс для завершения транзакции. Нажмите кнопку Отправить, когда откроется окно оплаты MetaMask. После всего этого вы должны увидеть баланс в размере 0,999937 ETH, потому что вы отправили 1 ETH в сеть с 0,000063 ETH в газе.(((range="endofrange", startref="ix_02intro-asciidoc7")))(((range="endofrange", startref="ix_02intro-asciidoc6")))
